      ...
      <Jumbotron>
        <Container>
          ...
          <p class="lead text-muted text-center">
            Interested in seeing more? Check out my <a href="https://github.com/taracdia/">github</a>.
            </p>
        </Container>
      </Jumbotron>
  ...
  return (
    <Col md="4" className="py-5">
      <Card>
        ...
        <Card.Body>
  <Card.Title><a href={props.exampleLink}>{props.title}</a></Card.Title>
          <Card.Text>
            {props.text}
          </Card.Text>
          <a href={props.githubLink}>
          <Button variant="outline-secondary">View On Github</Button>
          </a>
        </Card.Body>
      </Card>
    </Col>
